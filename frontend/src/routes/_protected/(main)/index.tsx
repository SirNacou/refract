			...
			<div className="flex flex-col gap-6">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-8 gap-6">
					<ClickTrendsChartCard
						...
						className="col-span-full md:col-span-2 xl:col-span-5 min-w-0"
					/>

					<Card className="col-span-full md:col-span-2 xl:col-span-3 min-w-0">
						<CardHeader>
				...
				/> */}
					...
					<div className="col-span-full xl:col-span-8 min-w-0">
